...
namespace Leap.Unity.PhysicalInterfaces {
  ...
  public static class MovementExtensions {
    ...
    public static Pose Integrated(this Pose pose, Movement movement, float deltaTime) {
      return new Pose(pose.position + movement.velocity * deltaTime,
        pose.rotation * Utils.QuaternionFromAngleAxisVector(movement.angularVelocity
                                                            * deltaTime));
    }
