...
namespace Leap.Unity.PhysicalInterfaces {
  ...
  public struct Pose {
    ...
    public void Integrate(Movement movement, float deltaTime) {
      position = movement.velocity * deltaTime + position;

      if (movement.angularVelocity.sqrMagnitude > 0.00001f) {
        rotation = Quaternion.AngleAxis(movement.angularVelocity.magnitude * deltaTime,
    ...
    // TODO: Determine if addition and subtraction operations are useful / useable.
